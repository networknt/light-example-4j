...
public class TodosPutHandlerTest {
    ...
    public void testTodosPutHandlerTest() throws ClientException, ApiException {
        ...
        try {
            ClientRequest request = new ClientRequest().setPath("/v1/todos").setMethod(Methods.PUT);

            request.getRequestHeaders().put(Headers.CONTENT_TYPE, "application/json");
            request.getRequestHeaders().put(Headers.TRANSFER_ENCODING, "chunked");
            connection.sendRequest(request, client.createClientCallback(reference, latch, "{\"id\":\"100\",\"title\":\"buy grocery\",\"completed\":false,\"order\":1}"));
