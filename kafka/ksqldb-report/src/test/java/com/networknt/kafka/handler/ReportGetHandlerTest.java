...
@Ignore
public class ReportGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ReportGetHandlerTest.class);
    ...
    @Test
    public void testReportGetHandlerTest() throws ClientException {
