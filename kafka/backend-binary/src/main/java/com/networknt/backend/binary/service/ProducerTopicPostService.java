...
public class ProducerTopicPostService implements HttpService<Void, String> {
    private static final Logger logger = LoggerFactory.getLogger(ProducerTopicPostService.class);
