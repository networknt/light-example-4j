...
@Ignore
public class ConsumerTopicGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ConsumerTopicGetHandlerTest.class);
    ...
    @Test
    public void testConsumerTopicGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/consumer/RIKEgRMIqQXlgOfIztUkVzAohS";
