...
@Ignore
public class KsqldbPostHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(KsqldbPostHandlerTest.class);
    ...
    @Test
    public void testKsqldbPostHandlerTest() throws ClientException {
