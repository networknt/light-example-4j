...
import com.networknt.foodstore.service.FoodGetService;
...
*/
public class FoodGetHandler implements LightHttpHandler {
    FoodGetService service;

    public FoodGetHandler () {
        this.service = new FoodGetService ();
    }
