...
public class FoodFoodIdGetService implements HttpService<Void, String> {
    private static final Logger logger = LoggerFactory.getLogger(FoodFoodIdGetService.class);
