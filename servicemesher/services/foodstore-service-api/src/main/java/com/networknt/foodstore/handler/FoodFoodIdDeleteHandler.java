...
import com.networknt.foodstore.service.FoodFoodIdDeleteService;
...
*/
public class FoodFoodIdDeleteHandler implements LightHttpHandler {
    FoodFoodIdDeleteService service;

    public FoodFoodIdDeleteHandler () {
        this.service = new FoodFoodIdDeleteService ();
    }
