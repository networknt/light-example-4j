...
import com.networknt.foodstore.service.FoodFoodIdGetService;
...
*/
public class FoodFoodIdGetHandler implements LightHttpHandler {
    FoodFoodIdGetService service;

    public FoodFoodIdGetHandler () {
        this.service = new FoodFoodIdGetService ();
    }
