...
@Ignore
public class FoodFoodIdDeleteHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(FoodFoodIdDeleteHandlerTest.class);
    ...
    @Test
    public void testFoodFoodIdDeleteHandlerTest() throws ClientException {
        ...
        String requestUri = "/v1/food/KJSmwdXxZrsfhGtZpnJgOSXeejjG";
        String httpMethod = "delete";
        try {
            ClientRequest request = new ClientRequest().setPath(requestUri).setMethod(Methods.DELETE);

            //customized header parameters
            request.getRequestHeaders().put(new HttpString("key"), "ekUHUOtKgStlDw");
