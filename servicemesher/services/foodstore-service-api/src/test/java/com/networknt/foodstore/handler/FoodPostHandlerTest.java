...
@Ignore
public class FoodPostHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(FoodPostHandlerTest.class);
    ...
    @Test
    public void testFoodPostHandlerTest() throws ClientException {
