...
@Ignore
public class FoodFoodIdGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(FoodFoodIdGetHandlerTest.class);
    ...
    @Test
    public void testFoodFoodIdGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/v1/food/ZwWWQaunxiHnUyvJtObROrQsmz";
