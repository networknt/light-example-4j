...
import com.networknt.bookstore.service.BooksBookIdDeleteService;
...
public class BooksBookIdDeleteHandler implements LightHttpHandler {
    BooksBookIdDeleteService service;

    public BooksBookIdDeleteHandler () {
        this.service = new BooksBookIdDeleteService ();
    }
