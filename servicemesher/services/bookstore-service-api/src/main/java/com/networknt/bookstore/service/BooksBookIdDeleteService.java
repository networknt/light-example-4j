...
public class BooksBookIdDeleteService implements HttpService<Void, String> {
    private static final Logger logger = LoggerFactory.getLogger(BooksBookIdDeleteService.class);
