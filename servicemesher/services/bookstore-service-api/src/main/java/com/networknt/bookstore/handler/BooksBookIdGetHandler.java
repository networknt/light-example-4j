...
import com.networknt.bookstore.service.BooksBookIdGetService;
...
*/
public class BooksBookIdGetHandler implements LightHttpHandler {
    BooksBookIdGetService service;

    public BooksBookIdGetHandler () {
        this.service = new BooksBookIdGetService ();
    }
