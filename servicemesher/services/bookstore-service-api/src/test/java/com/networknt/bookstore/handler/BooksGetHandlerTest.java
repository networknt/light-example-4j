...
@Ignore
public class BooksGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(BooksGetHandlerTest.class);
    ...
    @Test
    public void testBooksGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/v1/books?limit=31";
