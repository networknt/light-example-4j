...
@Ignore
public class BooksBookIdDeleteHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(BooksBookIdDeleteHandlerTest.class);
    ...
    @Test
    public void testBooksBookIdDeleteHandlerTest() throws ClientException {
        ...
        String requestUri = "/v1/books/CGwovYzhVnxVpHy";
        String httpMethod = "delete";
        try {
            ClientRequest request = new ClientRequest().setPath(requestUri).setMethod(Methods.DELETE);

            //customized header parameters
            request.getRequestHeaders().put(new HttpString("key"), "DUOXtCvKEYLqUOmUgPAdxiwDOIZaI");
