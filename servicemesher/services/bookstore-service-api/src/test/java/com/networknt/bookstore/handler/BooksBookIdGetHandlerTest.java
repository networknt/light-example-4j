...
@Ignore
public class BooksBookIdGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(BooksBookIdGetHandlerTest.class);
    ...
    @Test
    public void testBooksBookIdGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/v1/books/xwRgLyHCXjmgeznKAtmzLjKUIiRs";
