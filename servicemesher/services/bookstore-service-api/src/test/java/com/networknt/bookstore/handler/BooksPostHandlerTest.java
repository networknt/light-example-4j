...
@Ignore
public class BooksPostHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(BooksPostHandlerTest.class);
    ...
    @Test
    public void testBooksPostHandlerTest() throws ClientException {
