...
import com.networknt.computerstore.service.ComputersGetService;
...
public class ComputersGetHandler implements LightHttpHandler {
    ComputersGetService service;

    public ComputersGetHandler () {
        this.service = new ComputersGetService ();
    }
