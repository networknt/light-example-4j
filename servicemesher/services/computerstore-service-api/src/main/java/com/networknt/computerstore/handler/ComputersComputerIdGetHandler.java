...
import com.networknt.computerstore.service.ComputersComputerIdGetService;
...
*/
public class ComputersComputerIdGetHandler implements LightHttpHandler {
    ComputersComputerIdGetService service;

    public ComputersComputerIdGetHandler () {
        this.service = new ComputersComputerIdGetService ();
    }
