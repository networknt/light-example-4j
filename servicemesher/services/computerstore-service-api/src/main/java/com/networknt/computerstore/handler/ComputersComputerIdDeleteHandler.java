...
import com.networknt.computerstore.service.ComputersComputerIdDeleteService;
...
*/
public class ComputersComputerIdDeleteHandler implements LightHttpHandler {
    ComputersComputerIdDeleteService service;

    public ComputersComputerIdDeleteHandler () {
        this.service = new ComputersComputerIdDeleteService ();
    }
