...
import com.networknt.computerstore.service.ComputersPostService;
...
*/
public class ComputersPostHandler implements LightHttpHandler {
    ComputersPostService service;

    public ComputersPostHandler () {
        this.service = new ComputersPostService ();
    }
    ...
    public void handleRequest(HttpServerExchange exchange) throws Exception {
        ...
        Computer requestBody = Config.getInstance().getMapper().convertValue(bodyMap, Computer.class);
