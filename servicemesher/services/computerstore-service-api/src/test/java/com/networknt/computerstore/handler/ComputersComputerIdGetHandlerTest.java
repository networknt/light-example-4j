...
@Ignore
public class ComputersComputerIdGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ComputersComputerIdGetHandlerTest.class);
    ...
    @Test
    public void testComputersComputerIdGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/v1/computers/CrPSvgROcADtEhvSfGzhTniuZQF";
