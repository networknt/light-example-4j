...
@Ignore
public class ComputersPostHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ComputersPostHandlerTest.class);
    ...
    @Test
    public void testComputersPostHandlerTest() throws ClientException {
        ...
        String requestUri = "/v1/computers";
