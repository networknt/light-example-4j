...
@Ignore
public class ComputersGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ComputersGetHandlerTest.class);
    ...
    @Test
    public void testComputersGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/v1/computers?limit=45";
