...
@Ignore
public class ComputersComputerIdDeleteHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ComputersComputerIdDeleteHandlerTest.class);
    ...
    @Test
    public void testComputersComputerIdDeleteHandlerTest() throws ClientException {
        ...
        String requestUri = "/v1/computers/fwInnJDPiTiXRrgQEZLjiVerBjhMo";
        String httpMethod = "delete";
        try {
            ClientRequest request = new ClientRequest().setPath(requestUri).setMethod(Methods.DELETE);
            
            //customized header parameters 
            request.getRequestHeaders().put(new HttpString("key"), "yecrxmiLJQvaX");
