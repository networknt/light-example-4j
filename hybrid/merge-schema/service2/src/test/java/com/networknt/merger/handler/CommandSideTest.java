...
public class CommandSideTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(CommandSide.class);
    ...
    @Test
    public void testCommandSide() throws ClientException, ApiException {
        /*
