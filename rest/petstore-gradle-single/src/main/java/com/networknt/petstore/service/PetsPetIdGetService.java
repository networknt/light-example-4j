...
public class PetsPetIdGetService implements HttpService<Void, String> {
    private static final Logger logger = LoggerFactory.getLogger(PetsPetIdGetService.class);
