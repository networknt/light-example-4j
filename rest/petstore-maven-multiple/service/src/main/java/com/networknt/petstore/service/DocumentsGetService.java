...
public class DocumentsGetService implements HttpService<Void, String> {
    private static final Logger logger = LoggerFactory.getLogger(DocumentsGetService.class);
