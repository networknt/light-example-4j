...
public class StoreProductsGetHandlerTest {

    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(StoreProductsGetHandlerTest.class);
    ...
    @Test
    public void testStoreProductsGetHandlerTest() throws ClientException {
