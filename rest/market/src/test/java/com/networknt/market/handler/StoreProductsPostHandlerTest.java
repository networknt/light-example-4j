...
public class StoreProductsPostHandlerTest {

    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(StoreProductsPostHandlerTest.class);
    ...
    @Test
    public void testStoreProductsPostHandlerTest() throws ClientException {
        ...
        String requestUri = "/KcVZma/products";
