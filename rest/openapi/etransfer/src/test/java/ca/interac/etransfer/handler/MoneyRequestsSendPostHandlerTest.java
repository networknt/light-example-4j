...
@Ignore
public class MoneyRequestsSendPostHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(MoneyRequestsSendPostHandlerTest.class);
    ...
    @Test
    public void testMoneyRequestsSendPostHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/money-requests/send";
