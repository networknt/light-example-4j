...
@Ignore
public class MoneyRequestsReceiveReferenceNumberDeclinePatchHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(MoneyRequestsReceiveReferenceNumberDeclinePatchHandlerTest.class);
    ...
    @Test
    public void testMoneyRequestsReceiveReferenceNumberDeclinePatchHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/money-requests/receive/MOmWZsZHTX/decline";
