...
@Ignore
public class ContactsPostHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ContactsPostHandlerTest.class);
    ...
    @Test
    public void testContactsPostHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/contacts";
