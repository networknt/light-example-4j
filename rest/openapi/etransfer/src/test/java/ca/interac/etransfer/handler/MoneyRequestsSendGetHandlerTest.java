...
@Ignore
public class MoneyRequestsSendGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(MoneyRequestsSendGetHandlerTest.class);
    ...
    @Test
    public void testMoneyRequestsSendGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/money-requests/send?fromDate=uGHBlnnSx&toDate=VbvyXpllpEbGsByQCLJW&maxResponseItems=15&offset=53&sortBy=QRBDbz&orderBy=qePmlC&sourceMoneyRequestId=NFAQxDUggC&referenceNumber=ucNBXjbgSTfbZ";
