...
@Ignore
public class TransfersReceiveReferenceNumberCompletePatchHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(TransfersReceiveReferenceNumberCompletePatchHandlerTest.class);
    ...
    @Test
    public void testTransfersReceiveReferenceNumberCompletePatchHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/transfers/receive/lDrMrOKngvpTe/complete";
