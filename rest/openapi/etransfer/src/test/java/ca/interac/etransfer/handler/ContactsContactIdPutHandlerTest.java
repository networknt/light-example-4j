...
@Ignore
public class ContactsContactIdPutHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ContactsContactIdPutHandlerTest.class);
    ...
    @Test
    public void testContactsContactIdPutHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/contacts/kqhidpuQ";
