...
@Ignore
public class TransfersSendReferenceNumberNoticePatchHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(TransfersSendReferenceNumberNoticePatchHandlerTest.class);
    ...
    @Test
    public void testTransfersSendReferenceNumberNoticePatchHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/transfers/send/aOrFBr/notice";
