...
@Ignore
public class TransfersReceiveReferenceNumberAuthenticatePatchHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(TransfersReceiveReferenceNumberAuthenticatePatchHandlerTest.class);
    ...
    @Test
    public void testTransfersReceiveReferenceNumberAuthenticatePatchHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/transfers/receive/GDCAtSV/authenticate";
