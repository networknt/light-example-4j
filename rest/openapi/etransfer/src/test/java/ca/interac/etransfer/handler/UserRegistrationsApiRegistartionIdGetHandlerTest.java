...
@Ignore
public class UserRegistrationsApiRegistartionIdGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(UserRegistrationsApiRegistartionIdGetHandlerTest.class);
    ...
    @Test
    public void testUserRegistrationsApiRegistartionIdGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/user-registrations/ZDeLGIcJajwz";
