...
@Ignore
public class UserRegistrationsPostHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(UserRegistrationsPostHandlerTest.class);
    ...
    @Test
    public void testUserRegistrationsPostHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/user-registrations";
