...
@Ignore
public class TransfersSendPostHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(TransfersSendPostHandlerTest.class);
    ...
    @Test
    public void testTransfersSendPostHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/transfers/send";
