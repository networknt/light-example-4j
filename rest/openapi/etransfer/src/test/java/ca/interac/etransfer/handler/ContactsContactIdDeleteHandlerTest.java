...
@Ignore
public class ContactsContactIdDeleteHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ContactsContactIdDeleteHandlerTest.class);
    ...
    @Test
    public void testContactsContactIdDeleteHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/contacts/GjsbbHkcgGYwaU";
