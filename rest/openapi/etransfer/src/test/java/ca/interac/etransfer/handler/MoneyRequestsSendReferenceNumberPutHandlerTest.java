...
@Ignore
public class MoneyRequestsSendReferenceNumberPutHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(MoneyRequestsSendReferenceNumberPutHandlerTest.class);
    ...
    @Test
    public void testMoneyRequestsSendReferenceNumberPutHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/money-requests/send/graMRdUkC";
