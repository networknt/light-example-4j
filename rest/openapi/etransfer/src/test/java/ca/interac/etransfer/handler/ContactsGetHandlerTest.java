...
@Ignore
public class ContactsGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ContactsGetHandlerTest.class);
    ...
    @Test
    public void testContactsGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/contacts?maxResponseItems=91&fromLastUpdatedDate=iCVfpgmWLHfBPKeAexhscbMDi&offset=97&sortBy=CNotIBuiCDa&orderBy=yrlmDHXDBfkXCVSG";
