...
@Ignore
public class TransfersSendReferenceNumberCancelPatchHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(TransfersSendReferenceNumberCancelPatchHandlerTest.class);
    ...
    @Test
    public void testTransfersSendReferenceNumberCancelPatchHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/transfers/send/CVUdHosF/cancel";
