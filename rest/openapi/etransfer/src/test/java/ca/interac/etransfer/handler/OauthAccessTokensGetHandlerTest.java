...
@Ignore
public class OauthAccessTokensGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(OauthAccessTokensGetHandlerTest.class);
    ...
    @Test
    public void testOauthAccessTokensGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/oauth/access-tokens";
