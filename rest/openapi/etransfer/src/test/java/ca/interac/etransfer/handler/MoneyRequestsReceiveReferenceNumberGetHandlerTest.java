...
@Ignore
public class MoneyRequestsReceiveReferenceNumberGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(MoneyRequestsReceiveReferenceNumberGetHandlerTest.class);
    ...
    @Test
    public void testMoneyRequestsReceiveReferenceNumberGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/money-requests/receive/FIrXNdqgARQPgmYNMXjFzvTbLsAB";
