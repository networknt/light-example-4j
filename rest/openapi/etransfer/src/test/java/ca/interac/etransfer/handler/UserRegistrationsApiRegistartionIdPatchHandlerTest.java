...
@Ignore
public class UserRegistrationsApiRegistartionIdPatchHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(UserRegistrationsApiRegistartionIdPatchHandlerTest.class);
    ...
    @Test
    public void testUserRegistrationsApiRegistartionIdPatchHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/user-registrations/UJUTmITGhn";
