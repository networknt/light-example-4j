...
@Ignore
public class MoneyRequestsSendReferenceNumberCancelPatchHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(MoneyRequestsSendReferenceNumberCancelPatchHandlerTest.class);
    ...
    @Test
    public void testMoneyRequestsSendReferenceNumberCancelPatchHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/money-requests/send/oUOqbkuL/cancel";
