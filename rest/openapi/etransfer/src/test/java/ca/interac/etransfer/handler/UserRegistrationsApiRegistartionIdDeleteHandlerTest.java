...
@Ignore
public class UserRegistrationsApiRegistartionIdDeleteHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(UserRegistrationsApiRegistartionIdDeleteHandlerTest.class);
    ...
    @Test
    public void testUserRegistrationsApiRegistartionIdDeleteHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/user-registrations/VoLro";
