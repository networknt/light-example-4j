...
@Ignore
public class TransfersReceiveReferenceNumberDeclinePatchHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(TransfersReceiveReferenceNumberDeclinePatchHandlerTest.class);
    ...
    @Test
    public void testTransfersReceiveReferenceNumberDeclinePatchHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/transfers/receive/vCzvyWDbsV/decline";
