...
@Ignore
public class TransfersSendReferenceNumberUpdateTransferAuthenticationPatchHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(TransfersSendReferenceNumberUpdateTransferAuthenticationPatchHandlerTest.class);
    ...
    @Test
    public void testTransfersSendReferenceNumberUpdateTransferAuthenticationPatchHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/transfers/send/IITOMSluXPd/updateTransferAuthentication";
