...
@Ignore
public class ContactsContactIdGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ContactsContactIdGetHandlerTest.class);
    ...
    @Test
    public void testContactsContactIdGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/contacts/WZiiNHH";
