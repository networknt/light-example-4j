...
@Ignore
public class MoneyRequestsSendReferenceNumberNoticePatchHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(MoneyRequestsSendReferenceNumberNoticePatchHandlerTest.class);
    ...
    @Test
    public void testMoneyRequestsSendReferenceNumberNoticePatchHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/money-requests/send/ToJUExLfmH/notice";
