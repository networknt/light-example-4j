...
@Ignore
public class TransfersGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(TransfersGetHandlerTest.class);
    ...
    @Test
    public void testTransfersGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/transfers?fromDate=QPhhOHMQZWld&toDate=FjBnF&maxResponseItems=8&offset=82&sortBy=dtSxARLfgBvZMOKRfVTVKv&orderBy=VMaqPLgndXXVaFmDcoRXLa&sourceTransferId=mZIeOoBIdAleVukGrDMk&referenceNumber=SVjnqQzpJgwfx";
