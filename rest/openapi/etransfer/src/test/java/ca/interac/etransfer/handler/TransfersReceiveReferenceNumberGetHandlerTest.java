...
@Ignore
public class TransfersReceiveReferenceNumberGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(TransfersReceiveReferenceNumberGetHandlerTest.class);
    ...
    @Test
    public void testTransfersReceiveReferenceNumberGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/transfers/receive/mMqUU";
