...
*/
public class TransfersReceiveReferenceNumberAuthenticatePatchHandler implements LightHttpHandler {
    TransfersReceiveReferenceNumberAuthenticatePatchService service;

    public TransfersReceiveReferenceNumberAuthenticatePatchHandler () {
    ...
    public void handleRequest(HttpServerExchange exchange) throws Exception {
        ...
        SecurityAnswer requestBody = Config.getInstance().getMapper().convertValue(bodyMap, SecurityAnswer.class);
