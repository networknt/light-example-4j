...
import ca.interac.etransfer.model.TransferAuthentication;
...
*/
public class TransfersSendReferenceNumberUpdateTransferAuthenticationPatchHandler implements LightHttpHandler {
    TransfersSendReferenceNumberUpdateTransferAuthenticationPatchService service;

    public TransfersSendReferenceNumberUpdateTransferAuthenticationPatchHandler () {
        this.service = new TransfersSendReferenceNumberUpdateTransferAuthenticationPatchService ();
    }
    ...
    public void handleRequest(HttpServerExchange exchange) throws Exception {
        ...
        TransferAuthentication requestBody = Config.getInstance().getMapper().convertValue(bodyMap, TransferAuthentication.class);
