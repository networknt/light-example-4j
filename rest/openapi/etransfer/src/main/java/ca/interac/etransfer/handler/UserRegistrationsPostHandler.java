...
public class UserRegistrationsPostHandler implements LightHttpHandler {
    UserRegistrationsPostService service;

    public UserRegistrationsPostHandler () {
    ...
    public void handleRequest(HttpServerExchange exchange) throws Exception {
        ...
        UserRegistration requestBody = Config.getInstance().getMapper().convertValue(bodyMap, UserRegistration.class);
