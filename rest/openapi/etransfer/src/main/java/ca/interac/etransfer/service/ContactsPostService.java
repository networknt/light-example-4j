...
public class ContactsPostService implements HttpService<Contact, String> {
    private static final Logger logger = LoggerFactory.getLogger(ContactsPostService.class);
    ...
    public ResponseEntity invoke(RequestEntity<Contact> requestEntity) {
        ...
        String body = "[{\"code\":1005,\"message\":\"ApiRegistartionId doesn't exist\"},{\"code\":1006,\"message\":\"Hard contact doesn't exist.\"}]";
