...
*/
public class UserRegistrationsApiRegistartionIdPatchHandler implements LightHttpHandler {
    UserRegistrationsApiRegistartionIdPatchService service;

    public UserRegistrationsApiRegistartionIdPatchHandler () {
        this.service = new UserRegistrationsApiRegistartionIdPatchService ();
    }
    ...
    public void handleRequest(HttpServerExchange exchange) throws Exception {
        ...
        UserRegistrationUpdate requestBody = Config.getInstance().getMapper().convertValue(bodyMap, UserRegistrationUpdate.class);
