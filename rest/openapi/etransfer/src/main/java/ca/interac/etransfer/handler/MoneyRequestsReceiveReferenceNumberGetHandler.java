...
*/
public class MoneyRequestsReceiveReferenceNumberGetHandler implements LightHttpHandler {
    MoneyRequestsReceiveReferenceNumberGetService service;

    public MoneyRequestsReceiveReferenceNumberGetHandler () {
