...
*/
public class MoneyRequestsSendReferenceNumberCancelPatchHandler implements LightHttpHandler {
    MoneyRequestsSendReferenceNumberCancelPatchService service;

    public MoneyRequestsSendReferenceNumberCancelPatchHandler () {
        this.service = new MoneyRequestsSendReferenceNumberCancelPatchService ();
    }
    ...
    public void handleRequest(HttpServerExchange exchange) throws Exception {
        ...
        CancellationReason requestBody = Config.getInstance().getMapper().convertValue(bodyMap, CancellationReason.class);
