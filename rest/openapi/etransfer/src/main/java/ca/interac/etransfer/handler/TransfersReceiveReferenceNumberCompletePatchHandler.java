...
public class TransfersReceiveReferenceNumberCompletePatchHandler implements LightHttpHandler {
    TransfersReceiveReferenceNumberCompletePatchService service;

    public TransfersReceiveReferenceNumberCompletePatchHandler () {
    ...
    public void handleRequest(HttpServerExchange exchange) throws Exception {
        ...
        RecipientMemo requestBody = Config.getInstance().getMapper().convertValue(bodyMap, RecipientMemo.class);
