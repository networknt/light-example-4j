...
*/
public class TransfersReceiveReferenceNumberGetHandler implements LightHttpHandler {
    TransfersReceiveReferenceNumberGetService service;

    public TransfersReceiveReferenceNumberGetHandler () {
        this.service = new TransfersReceiveReferenceNumberGetService ();
    }
