...
public class MoneyRequestsReceiveReferenceNumberGetService implements HttpService<Void, String> {
    private static final Logger logger = LoggerFactory.getLogger(MoneyRequestsReceiveReferenceNumberGetService.class);
