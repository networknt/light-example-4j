...
*/
public class MoneyRequestsSendReferenceNumberNoticePatchHandler implements LightHttpHandler {
    MoneyRequestsSendReferenceNumberNoticePatchService service;

    public MoneyRequestsSendReferenceNumberNoticePatchHandler () {
