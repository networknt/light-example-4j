...
*/
public class TransfersSendReferenceNumberCancelPatchHandler implements LightHttpHandler {
    TransfersSendReferenceNumberCancelPatchService service;

    public TransfersSendReferenceNumberCancelPatchHandler () {
        this.service = new TransfersSendReferenceNumberCancelPatchService ();
    }
