...
public class MoneyRequestsSendReferenceNumberPutHandler implements LightHttpHandler {
    MoneyRequestsSendReferenceNumberPutService service;

    public MoneyRequestsSendReferenceNumberPutHandler () {
        this.service = new MoneyRequestsSendReferenceNumberPutService ();
    }
