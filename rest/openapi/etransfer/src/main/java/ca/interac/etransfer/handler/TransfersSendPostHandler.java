...
public class TransfersSendPostHandler implements LightHttpHandler {
    TransfersSendPostService service;

    public TransfersSendPostHandler () {
        this.service = new TransfersSendPostService ();
    }
    ...
    public void handleRequest(HttpServerExchange exchange) throws Exception {
        ...
        Transfer requestBody = Config.getInstance().getMapper().convertValue(bodyMap, Transfer.class);
