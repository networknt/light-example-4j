...
public class UserRegistrationsApiRegistartionIdDeleteHandler implements LightHttpHandler {
    UserRegistrationsApiRegistartionIdDeleteService service;

    public UserRegistrationsApiRegistartionIdDeleteHandler () {
        this.service = new UserRegistrationsApiRegistartionIdDeleteService ();
    }
