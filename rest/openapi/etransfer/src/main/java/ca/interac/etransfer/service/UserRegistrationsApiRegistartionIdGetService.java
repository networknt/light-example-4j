...
public class UserRegistrationsApiRegistartionIdGetService implements HttpService<Void, String> {
    private static final Logger logger = LoggerFactory.getLogger(UserRegistrationsApiRegistartionIdGetService.class);
