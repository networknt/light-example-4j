...
public class TransfersSendReferenceNumberNoticePatchService implements HttpService<Void, String> {
    private static final Logger logger = LoggerFactory.getLogger(TransfersSendReferenceNumberNoticePatchService.class);
