...
*/
public class ContactsContactIdPutHandler implements LightHttpHandler {
    ContactsContactIdPutService service;

    public ContactsContactIdPutHandler () {
        this.service = new ContactsContactIdPutService ();
    }
