...
*/
public class MoneyRequestsSendPostHandler implements LightHttpHandler {
    MoneyRequestsSendPostService service;

    public MoneyRequestsSendPostHandler () {
        this.service = new MoneyRequestsSendPostService ();
    }
    ...
    public void handleRequest(HttpServerExchange exchange) throws Exception {
        ...
        MoneyRequest requestBody = Config.getInstance().getMapper().convertValue(bodyMap, MoneyRequest.class);
