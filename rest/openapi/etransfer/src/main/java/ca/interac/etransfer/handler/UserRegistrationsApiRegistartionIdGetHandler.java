...
*/
public class UserRegistrationsApiRegistartionIdGetHandler implements LightHttpHandler {
    UserRegistrationsApiRegistartionIdGetService service;

    public UserRegistrationsApiRegistartionIdGetHandler () {
