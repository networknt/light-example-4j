...
*/
public class MoneyRequestsReceiveReferenceNumberDeclinePatchHandler implements LightHttpHandler {
    MoneyRequestsReceiveReferenceNumberDeclinePatchService service;

    public MoneyRequestsReceiveReferenceNumberDeclinePatchHandler () {
    ...
    public void handleRequest(HttpServerExchange exchange) throws Exception {
        ...
        DeclineReason requestBody = Config.getInstance().getMapper().convertValue(bodyMap, DeclineReason.class);
