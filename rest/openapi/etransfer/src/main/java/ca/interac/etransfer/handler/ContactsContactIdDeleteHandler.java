...
*/
public class ContactsContactIdDeleteHandler implements LightHttpHandler {
    ContactsContactIdDeleteService service;

    public ContactsContactIdDeleteHandler () {
        this.service = new ContactsContactIdDeleteService ();
    }
