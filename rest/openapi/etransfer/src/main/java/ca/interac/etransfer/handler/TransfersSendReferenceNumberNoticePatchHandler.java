...
*/
public class TransfersSendReferenceNumberNoticePatchHandler implements LightHttpHandler {
    TransfersSendReferenceNumberNoticePatchService service;

    public TransfersSendReferenceNumberNoticePatchHandler () {
