...
public class MoneyRequestsSendPostService implements HttpService<MoneyRequest, String> {
    private static final Logger logger = LoggerFactory.getLogger(MoneyRequestsSendPostService.class);
