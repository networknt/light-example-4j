...
public class ContactsContactIdDeleteService implements HttpService<Void, String> {
    private static final Logger logger = LoggerFactory.getLogger(ContactsContactIdDeleteService.class);
