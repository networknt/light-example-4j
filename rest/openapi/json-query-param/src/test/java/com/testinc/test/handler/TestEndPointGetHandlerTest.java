...
@Ignore
public class TestEndPointGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(TestEndPointGetHandlerTest.class);
    ...
    @Test
    public void testTestEndPointGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/api/testEndPoint?TestObject=";
