...
public class AccountsGetHandlerTest {

    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(AccountsGetHandlerTest.class);
    ...
    @Test
    public void testAccountsGetHandlerTest() throws ClientException {
