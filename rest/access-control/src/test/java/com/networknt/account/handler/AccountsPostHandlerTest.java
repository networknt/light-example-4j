...
package com.networknt.account.handler;
...
public class AccountsPostHandlerTest {

    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(AccountsPostHandlerTest.class);
    ...
    @Test
    public void testAccountsPostHandlerTest() throws ClientException {
