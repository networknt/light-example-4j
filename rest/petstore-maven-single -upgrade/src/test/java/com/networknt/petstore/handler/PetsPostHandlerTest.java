...
public class PetsPostHandlerTest {
    ...
    static final ObjectMapper objectMapper = Config.getInstance().getMapper();
    @Test
    public void testPetsPostHandlerTest() throws ClientException {
        ...
        try {
            ...
            connection.sendRequest(request, client.createClientCallback(reference, latch, objectMapper.writeValueAsString(pet)));
