...
public class DataGetHandler implements HttpHandler {
    ...
    public DataGetHandler() {
        try {
            SimpleConnectionHolder.ConnectionToken token = client.borrow(new URI(apicHost), Http2Client.WORKER, Http2Client.SSL, Http2Client.BUFFER_POOL, OptionMap.create(UndertowOptions.ENABLE_HTTP2, true));
