...
@Ignore
public class QueryUserIdGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(QueryUserIdGetHandlerTest.class);
    ...
    @Test
    public void testQueryUserIdGetHandlerTest() throws ClientException {
        ...
        try {
            if(enableHttps) {
                token = client.borrow(new URI(url), Http2Client.WORKER, client.getDefaultXnioSsl(), Http2Client.BUFFER_POOL, enableHttp2 ? OptionMap.create(UndertowOptions.ENABLE_HTTP2, true): OptionMap.EMPTY);
        ...
        String requestUri = "/query/yHKAwnYXDodWkMSWF";
