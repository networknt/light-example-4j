...
public class KafkaRecordsPostHandlerTest {

    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(KafkaRecordsPostHandlerTest.class);
    ...
    @Test
    public void testKafkaRecordsPostHandlerTest() throws ClientException {
        ...
        String requestUri = "/kafka/records";
